...
export interface ActionPayload {
  ...
  readonly IAP__GET_PRODUCTS_FAILED: { errorCode: string };
  ...
  readonly IAP__PROCESS_PURCHASE_FAILED: { errorCode: string };
  ...
  readonly AD__INITIALIZE_FAILED: { errorCode: string };
  ...
  readonly AD__SHOW_GOOGLE_CONSENT_FORM_FAILED: { errorCode: string };
  ...
  readonly AD__LOAD_AD_FAILED: { errorCode: string };
  readonly AD__SHOW_AD: null;
  readonly AD__SHOWING_AD: null;
  readonly AD__SHOW_AD_SUCCEEDED: null;
  readonly AD__SHOW_AD_FAILED: { errorCode: string };
  ...
  readonly API_KEY__GET_API_KEY_FAILED: { errorCode: string };
  ...
  readonly API_KEY__DELETE_API_KEY_FAILED: { errorCode: string };
  ...
  readonly API_KEY__SEND_API_KEY_FAILED: { errorCode: string };
  ...
  readonly ATOM__PREPARE_FETCH_VOCABULARY_FAILED: { errorCode: string };
  ...
  readonly ATOM__FETCH_VOCABULARY_FAILED: { errorCode: string };
  ...
  readonly AUDIO__SYNTHESIZE_SPEECH_FAILED: { errorCode: string };
  ...
  readonly CATEGORY__PREPARE_FETCH_SUGGESTIONS_FAILED: { errorCode: string };
  ...
  readonly CATEGORY__FETCH_SUGGESTIONS_FAILED: { errorCode: string };
  ...
  readonly DATABASE__CONNECT_SHARED_DB_FAILED: { errorCode: string };
  ...
  readonly DATABASE__CHECK_SHARED_DB_FAILED: { errorCode: string };
  ...
  readonly DATABASE__CONNECT_USER_DB_FAILED: { errorCode: string };
  ...
  readonly DATABASE__CHECK_USER_DB_FAILED: { errorCode: string };
  ...
  readonly DICTIONARY__GET_ENTRY_FAILED: {
    searchTerm: string;
    errorCode: string;
  };
  ...
  readonly LIBRARY__PREPARE_SEARCH_PUBLIC_VOCABULARY_FAILED: {
    errorCode: string;
  };
  ...
  readonly LIBRARY__SEARCH_PUBLIC_VOCABULARY_FAILED: { errorCode: string };
  ...
  readonly LIBRARY__PREPARE_SEARCH_PUBLIC_SETS_FAILED: { errorCode: string };
  ...
  readonly LIBRARY__SEARCH_PUBLIC_SETS_FAILED: { errorCode: string };
  ...
  readonly LIBRARY__GET_PUBLIC_SET_COUNT_FAILED: { errorCode: string };
  ...
  readonly MANAGE__PREPARE_FETCH_VOCABULARY_FAILED: { errorCode: string };
  ...
  readonly MANAGE__FETCH_VOCABULARY_FAILED: { errorCode: string };
  ...
  readonly MANAGE__PREPARE_FETCH_CATEGORY_FAILED: { errorCode: string };
  ...
  readonly MANAGE__FETCH_CATEGORY_FAILED: { errorCode: string };
  ...
  readonly NETWORK__CHECK_CONNECTION_FAILED: { errorCode: string };
  readonly NETWORK__OBSERVE_CONNECTION_CHANGE: null;
  readonly NETWORK__OBSERVING_CONNECTION_CHANGE: null;
  readonly NETWORK__OBSERVE_CONNECTION_CHANGE_FAILED: { errorCode: string };
  ...
  readonly QUIZ__FETCH_VOCABULARY_FOR_WRITING_FAILED: {
    setId: string;
    errorCode: string;
  };
  ...
  readonly QUIZ__FETCH_VOCABULARY_FOR_MULTIPLE_CHOICE_FAILED: {
    setId: string;
    errorCode: string;
  };
  ...
  readonly REFLEX__PREPARE_FETCH_VOCABULARY_FAILED: { errorCode: string };
  ...
  readonly REFLEX__FETCH_VOCABULARY_FAILED: { errorCode: string };
  ...
  readonly ROOT__FORK_PROTECTED_SAGAS_FAILED: { errorCode: string };
  ...
  readonly ROOT__CANCEL_PROTECTED_SAGAS_FAILED: { errorCode: string };
  ...
  readonly SEARCH__PREPARE_SEARCH_FAILED: { errorCode: string };
  ...
  readonly SEARCH__SEARCH_FAILED: { errorCode: string };
  ...
  readonly SET__ADD_FAILED: { set: Set; errorCode: string };
  ...
  readonly SET__FETCH_FAILED: { setStatus: SetStatus; errorCode: string };
  ...
  readonly SPACED_REPETITION__FETCH_VOCABULARY_FAILED: {
    setId: string;
    errorCode: string;
  };
  ...
  readonly SPACED_REPETITION__SAVE_RESULT_FAILED: { errorCode: string };
  ...
  readonly SYNC__OBSERVE_LOCAL_UPDATES_FOR_SYNCING_FAILED: {
    errorCode: string;
  };
  readonly SYNC__OBSERVE_REMOTE_UPDATES_FOR_SYNCING: null;
  readonly SYNC__OBSERVING_REMOTE_UPDATES_FOR_SYNCING: null;
  readonly SYNC__OBSERVE_REMOTE_UPDATES_FOR_SYNCING_FAILED: {
    errorCode: string;
  };
  ...
  readonly TRANSLATION__TRANSLATE_FAILED: {
    sourceText: string;
    translator: string;
    errorCode: string;
  };
  ...
  readonly TRANSLATION__TRANSLATE_BIDIRECTION_FAILED: { errorCode: string };
  ...
  readonly USER__GET_SESSION_FAILED: { errorCode: string };
  ...
  readonly USER__CHECK_SESSION_FAILED: { errorCode: string };
  ...
  readonly USER__SIGN_IN_FAILED: { errorCode: string };
  ...
  readonly USER__SIGN_IN_AS_GUEST_FAILED: { errorCode: string };
  ...
  readonly USER__REQUEST_PASSWORD_RESET_EMAIL_FAILED: { errorCode: string };
  ...
  readonly USER__CHANGE_EMAIL_AND_PASSWORD_FAILED: { errorCode: string };
  ...
  readonly USER__CHANGE_EMAIL_FAILED: { errorCode: string };
  ...
  readonly USER__CONTACT_ADMIN_FAILED: { errorCode: string };
  ...
  readonly VOCABULARY__ADD_FAILED: {
  ...
  readonly VOCABULARY__ADD_MULTIPLE_FAILED: {
    vocabularyList: readonly Vocabulary[];
    errorCode: string;
  };
  ...
  readonly VOCABULARY__EDIT_FAILED: {
    vocabulary: DeepPartial<Vocabulary>;
    errorCode: string;
  };
  ...
  readonly VOCABULARY__EDIT_MULTIPLE_FAILED: {
    vocabularyList: readonly DeepPartial<Vocabulary>[];
    errorCode: string;
  };
  ...
  readonly VOCABULARY__UPLOAD_VOCABULARY_FAILED: { errorCode: string };
  readonly VOCABULARY__DOWNLOADING_VOCABULARY: { startAt: null | Date };
  readonly VOCABULARY__DOWNLOAD_VOCABULARY_SUCCEEDED: {
    vocabularyList: readonly Vocabulary[];
    noMore: boolean;
  };
  readonly VOCABULARY__DOWNLOAD_VOCABULARY_FAILED: { errorCode: string };
  ...
  readonly VOCABULARY__DOWNLOAD_INCOMPATIBLE_VOCABULARY_FAILED: {
    errorCode: string;
  };
  ...
  readonly VOCABULARY__PREPARE_FETCH_FAILED: { errorCode: string };
  ...
  readonly VOCABULARY__FETCH_FAILED: { errorCode: string };
  ...
  readonly WRITING__FETCH_VOCABULARY_FAILED: {
    setId: string;
    errorCode: string;
  };
  ...
  readonly WRITING__SAVE_RESULT_FAILED: { errorCode: string };
  ...
  readonly FLASHCARD_PLAYER__UPLOAD_FAILED: { errorCode: string };
  ...
  readonly IMAGE__PREPARE_SEARCH_IMAGES_FAILED: { errorCode: string };
  ...
  readonly IMAGE__SEARCH_IMAGES_FAILED: { errorCode: string };
  ...
  readonly IMAGE__UPLOAD_IMAGES_FAILED: { errorCode: string };
  ...
  readonly REMINDER__CHECK_PERMISSION_FAILED: { errorCode: string };
  ...
  readonly REMINDER__REQUEST_PERMISSION_FAILED: { errorCode: string };
  ...
  readonly REMINDER__SET_UP_REMINDER_FAILED: { errorCode: string };
  ...
  readonly REMINDER__DELETE_REMINDER_FAILED: { errorCode: string };
