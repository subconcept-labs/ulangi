...
export enum ActionType {
  ...
  MANAGE__FETCH_SPACED_REPETITION_DUE_AND_NEW_COUNTS = 'MANAGE__FETCH_SPACED_REPETITION_DUE_AND_NEW_COUNTS',
  MANAGE__FETCHING_SPACED_REPETITION_DUE_AND_NEW_COUNTS = 'MANAGE__FETCHING_SPACED_REPETITION_DUE_AND_NEW_COUNTS',
  MANAGE__FETCH_SPACED_REPETITION_DUE_AND_NEW_COUNTS_SUCCEEDED = 'MANAGE__FETCH_SPACED_REPETITION_DUE_AND_NEW_COUNTS_SUCCEEDED',
  MANAGE__FETCH_SPACED_REPETITION_DUE_AND_NEW_COUNTS_FAILED = 'MANAGE__FETCH_SPACED_REPETITION_DUE_AND_NEW_COUNTS_FAILED',
  MANAGE__FETCH_WRITING_DUE_AND_NEW_COUNTS = 'MANAGE__FETCH_WRITING_DUE_AND_NEW_COUNTS',
  MANAGE__FETCHING_WRITING_DUE_AND_NEW_COUNTS = 'MANAGE__FETCHING_WRITING_DUE_AND_NEW_COUNTS',
  MANAGE__FETCH_WRITING_DUE_AND_NEW_COUNTS_SUCCEEDED = 'MANAGE__FETCH_WRITING_DUE_AND_NEW_COUNTS_SUCCEEDED',
  MANAGE__FETCH_WRITING_DUE_AND_NEW_COUNTS_FAILED = 'MANAGE__FETCH_WRITING_DUE_AND_NEW_COUNTS_FAILED',
  ...
  REMOTE_CONFIG__UPDATING = 'REMOTE_CONFIG__UPDATING',
  ...
  SPACED_REPETITION__FETCH_DUE_AND_NEW_COUNTS = 'SPACED_REPETITION__FETCH_DUE_AND_NEW_COUNTS',
  SPACED_REPETITION__FETCHING_DUE_AND_NEW_COUNTS = 'SPACED_REPETITION__FETCHING_DUE_AND_NEW_COUNTS',
  SPACED_REPETITION__FETCH_DUE_AND_NEW_COUNTS_SUCCEEDED = 'SPACED_REPETITION__FETCH_DUE_AND_NEW_COUNTS_SUCCEEDED',
  SPACED_REPETITION__FETCH_DUE_AND_NEW_COUNTS_FAILED = 'SPACED_REPETITION__FETCH_DUE_AND_NEW_COUNTS_FAILED',
  SPACED_REPETITION__CLEAR_DUE_AND_NEW_COUNTS = 'SPACED_REPETITION__CLEAR_DUE_AND_NEW_COUNTS',
  ...
  VOCABULARY__BULK_EDIT = 'VOCABULARY__BULK_EDIT',
  VOCABULARY__BULK_EDITING = 'VOCABULARY__BULK_EDITING',
  VOCABULARY__BULK_EDIT_SUCCEEDED = 'VOCABULARY__BULK_EDIT_SUCCEEDED',
  VOCABULARY__BULK_EDIT_FAILED = 'VOCABULARY__BULK_EDIT_FAILED',
  ...
  WRITING__FETCH_DUE_AND_NEW_COUNTS = 'WRITING__FETCH_DUE_AND_NEW_COUNTS',
  WRITING__FETCHING_DUE_AND_NEW_COUNTS = 'WRITING__FETCHING_DUE_AND_NEW_COUNTS',
  WRITING__FETCH_DUE_AND_NEW_COUNTS_SUCCEEDED = 'WRITING__FETCH_DUE_AND_NEW_COUNTS_SUCCEEDED',
  WRITING__FETCH_DUE_AND_NEW_COUNTS_FAILED = 'WRITING__FETCH_DUE_AND_NEW_COUNTS_FAILED',
  WRITING__CLEAR_DUE_AND_NEW_COUNTS = 'WRITING__CLEAR_DUE_AND_NEW_COUNTS',
  ...
  LESSON_RESULTS__UPLOAD = 'LESSON_RESULTS__UPLOAD',
  LESSON_RESULTS__UPLOADING = 'LESSON_RESULTS__UPLOADING',
  LESSON_RESULTS__UPLOAD_SUCCEEDED = 'LESSON_RESULTS__UPLOAD_SUCCEEDED',
  LESSON_RESULTS__UPLOAD_FAILED = 'LESSON_RESULTS__UPLOAD_FAILED',

  STATISTICS__GET_STATISTICS = 'STATISTICS__GET_STATISTICS',
  STATISTICS__GETTING_STATISTICS = 'STATISTICS__GETTING_STATISTICS',
  STATISTICS__GET_STATISTICS_SUCCEEDED = 'STATISTICS__GET_STATISTICS_SUCCEEDED',
  STATISTICS__GET_STATISTICS_FAILED = 'STATISTICS__GET_STATISTICS_FAILED',

  STATISTICS__GET_HEAT_MAP_DATA = 'STATISTICS__GET_HEAT_MAP_DATA',
  STATISTICS__GETTING_HEAT_MAP_DATA = 'STATISTICS__GETTING_HEAT_MAP_DATA',
  STATISTICS__GET_HEAT_MAP_DATA_SUCCEEDED = 'STATISTICS__GET_HEAT_MAP_DATA_SUCCEEDED',
  STATISTICS__GET_HEAT_MAP_DATA_FAILED = 'STATISTICS__GET_HEAT_MAP_DATA_FAILED',
}
