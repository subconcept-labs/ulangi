...
describe('API endpoint /search-public-vocabulary', (): void => {
  ...
  it('cannot search public vocabulary if acccess token is not provided', async (): Promise<
    void
  > => {
    await expect(
      Axios.get(env.API_URL + '/search-public-vocabulary')
