...
describe('API endpoint /search-native-sets', (): void => {
  ...
  it('cannot search native sets if acccess token is not provided', async (): Promise<
    void
  > => {
    await expect(
      Axios.get(env.API_URL + '/search-native-sets')
