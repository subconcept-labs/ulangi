...
export class MultipleChoiceFormTopResponsiveStyles extends ResponsiveStyleSheet<
  MultipleChoiceFormTopStyles
> {
  public baseStyles(scaleByFactor: ScaleByFactor): MultipleChoiceFormTopStyles {
    return {
      container: {
  ...
  public lightStyles(): Partial<MultipleChoiceFormTopStyles> {
    return {
      number_container: {
  ...
  public darkStyles(): Partial<MultipleChoiceFormTopStyles> {
    return {
      number_container: {
...
export const multipleChoiceFormTopResponsiveStyles = new MultipleChoiceFormTopResponsiveStyles();
