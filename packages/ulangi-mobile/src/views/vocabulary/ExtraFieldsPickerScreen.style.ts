...
export class ExtraFieldsPickerScreenResponsiveStyles extends ResponsiveStyleSheet<
...
> {
  ...
  public lightStyles(): Partial<ExtraFieldsPickerScreenStyles> {
    return {
      picker_header: {
  ...
  public darkStyles(): Partial<ExtraFieldsPickerScreenStyles> {
    return {
      picker_header: {
...
export const extraFieldsPickerScreenResponsiveStyles = new ExtraFieldsPickerScreenResponsiveStyles();
