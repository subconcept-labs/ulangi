...
describe('Delete multiple vocabulary', (): void => {
  describe(`Test starts at ManageScreen after adding multiple terms`, (): void => {
    ...
    it('delete multiple active vocabulary in manage screen', async (): Promise<
      void
    > => {
    ...
    > => {
      ...
      await categoryDetailScreen.deleteSelectedVocabulary();
      await lightBoxDialog.close();
