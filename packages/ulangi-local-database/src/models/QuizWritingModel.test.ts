...
import { QuizWritingModel } from './QuizWritingModel';
...
describe('QuizWritingModel', (): void => {
  describe('Tests start with connected database', (): void => {
    ...
    let quizWritingModel: QuizWritingModel;
    ...
    beforeEach(
      async (): Promise<void> => {
        ...
        quizWritingModel = modelFactory.createModel('quizWritingModel');
    ...
    describe('Tests start after inserting some sets from remote', (): void => {
      ...
      describe('Tests start after inserting terms from local', (): void => {
        ...
        test('get learned vocabulary for writing quiz', async (): Promise<
          void
        > => {
          let startRange = 1;
        ...
        test('get learned vocabulary with selected categories for writing quiz', async (): Promise<
          void
        > => {
          let startRange = 1;
          for (const vocabulary of vocabularyList) {
        ...
        test('get learned vocabulary with Uncategorized for writing quiz', async (): Promise<
          void
        > => {
          let startRange = 1;
          for (const vocabulary of vocabularyList) {
        ...
        test('get learned vocabulary with excluded categories for writing quiz', async (): Promise<
          void
        > => {
          let startRange = 1;
          for (const vocabulary of vocabularyList) {
        ...
        test('get learned vocabulary excluding Uncategorized for writing quiz', async (): Promise<
          void
        > => {
          let startRange = 1;
          for (const vocabulary of vocabularyList) {
        ...
        test('get active vocabulary for writing quiz', async (): Promise<
          void
        > => {
          let startRange = 1;
          for (const vocabulary of vocabularyList) {
        ...
        test('get active vocabulary with selected categories for writing quiz', async (): Promise<
          void
        > => {
          let startRange = 1;
          for (const vocabulary of vocabularyList) {
        ...
        test('get active vocabulary with Uncategorized for writing quiz', async (): Promise<
          void
        > => {
          let startRange = 1;
          for (const vocabulary of vocabularyList) {
        ...
        test('get active vocabulary with excluded categories for writing quiz', async (): Promise<
          void
        > => {
          let startRange = 1;
          for (const vocabulary of vocabularyList) {
        ...
        test('get active vocabulary excluding Uncategorized for writing quiz', async (): Promise<
          void
        > => {
          let startRange = 1;
          for (const vocabulary of vocabularyList) {
